    ...
    <div class="policy_container">
      ...
      <div class="ol">
        ...
        <div class="li">
          ...
          <span class="mark">httpsː//thismywebsite·com</span>.
        </div>
      </div>
      ...
      <div class="ol">
        ...
        <div class="li">
          5.4. Вышеперечисленные данные далее по тексту Политики объединены
      ...
      <div class="ol">
        ...
        <div class="li">
          ...
          электронной почты
          <span class="mark">privacy@thismywebsite·com</span> с пометкой «Отказ
      ...
      <div class="ol">
        ...
        <div class="li">
          ...
          <span class="mark">httpsː//thismywebsite·com</span> или направленные
      ...
      <div class="ol">
        ...
        <div class="li">
          ...
          <span class="mark">privacy@thismywebsite·com</span> с пометкой
        ...
        <div class="li">
          ...
          <span class="mark">privacy@thismywebsite·com</span> с пометкой «Отзыв
      ...
      <div class="ol">
        <div class="li">
          ...
          <span class="mark">privacy@thismywebsite·com</span>.
        </div>
        <div class="li">
        ...
        <div class="li">
          ...
          <span class="mark">httpsː//thismywebsite·com/privacy/</span>.
        </div>
      </div>
    </div>
  </div>
